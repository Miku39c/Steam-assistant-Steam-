...
'showFlag': true,            /* (optional) show/hide the flag 显示/隐藏旗帜 */
'showCountry': true,         /* (optional) show/hide the country name 显示/隐藏国家名称 */
...
'languages' : {              /* (optional) define **ADDITIONAL** custom languages 定义**额外的**自定义语言 */
    'italian' : {
        ...
        'flag' : {
            'url' : 'http://upload.wikimedia.org/wikipedia/commons/f/fb/Farm-Fresh_italy.png', /* url of flag image 标志图像url */
            'class' : 'italian-flag' /* (optional) class to assign to the flag (e.g., for css styling) 类来分配给标志(例如，用于css样式) */
        }
    },
    'barletta-dialect' : {
        'country': 'Barletta',
